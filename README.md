...
```javascript
gsumkbn2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsumkbn2@v0.3.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsumkbn2/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsumkbn2/actions/workflows/test.yml?query=branch:v0.3.0
